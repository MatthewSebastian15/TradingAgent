...
DATA_VENDOR_TECHNICAL_INDICATORS = env("DATA_VENDOR_TECHNICAL_INDICATORS", "yfinance,finnhub,alpha_vantage")
DATA_VENDOR_FUNDAMENTAL_DATA = env("DATA_VENDOR_FUNDAMENTAL_DATA", "yfinance,finnhub,alpha_vantage")
DATA_VENDOR_NEWS_DATA = env("DATA_VENDOR_NEWS_DATA", "google_news_light,marketaux,newsdata,yfinance,finnhub,alpha_vantage")
DATA_VENDOR_QUOTE_DATA = env("DATA_VENDOR_QUOTE_DATA", "yfinance,finnhub,alpha_vantage")
DATA_VENDOR_FINANCIAL_STATEMENTS = env("DATA_VENDOR_FINANCIAL_STATEMENTS", "yfinance,sec_companyfacts,alpha_vantage,finnhub")
...
NEWS_DECISION_MIN_RELEVANCE_SCORE = env_float("NEWS_DECISION_MIN_RELEVANCE_SCORE", 70, min_value=0, max_value=100)
...
NEWS_RSS_MAX_FEEDS = env_int("NEWS_RSS_MAX_FEEDS", 10, min_value=1)
...
GENERAL_NEWS_REFRESH_INTERVAL_SECONDS = env_int("GENERAL_NEWS_REFRESH_INTERVAL_SECONDS", 120, min_value=30)
GENERAL_NEWS_CACHE_TTL_SECONDS = env_int("GENERAL_NEWS_CACHE_TTL_SECONDS", 120, min_value=30)
...
GENERAL_NEWS_DEFAULT_WINDOW_DAYS = env_int("GENERAL_NEWS_DEFAULT_WINDOW_DAYS", 7, min_value=1)
GENERAL_NEWS_MAX_ARTICLES_PER_PROVIDER = env_int("GENERAL_NEWS_MAX_ARTICLES_PER_PROVIDER", 30, min_value=1)
GENERAL_NEWS_MAX_ARTICLES_FOR_UI = env_int("GENERAL_NEWS_MAX_ARTICLES_FOR_UI", 100, min_value=1)
...
GENERAL_NEWS_RSS_MAX_FEEDS = env_int("GENERAL_NEWS_RSS_MAX_FEEDS", 20, min_value=1)

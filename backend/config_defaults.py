...
NEWS_MAX_ARTICLES_FOR_PROMPT = env_int("NEWS_MAX_ARTICLES_FOR_PROMPT", 10, min_value=1)
NEWS_MAX_ARTICLES_FOR_UI = env_int("NEWS_MAX_ARTICLES_FOR_UI", 30, min_value=1)
NEWS_MIN_RELEVANCE_SCORE = env_int("NEWS_MIN_RELEVANCE_SCORE", 40, min_value=0)
NEWS_PROMPT_MIN_RELEVANCE_SCORE = env_int("NEWS_PROMPT_MIN_RELEVANCE_SCORE", 55, min_value=0)

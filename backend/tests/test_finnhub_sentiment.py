...
from tradingagents.dataflows.providers.finnhub_sentiment import (
    get_news_sentiment,
...
def test_get_news_sentiment_success(monkeypatch):
    monkeypatch.setattr(
        "tradingagents.dataflows.providers.finnhub_sentiment.make_api_request",
...
def test_get_news_sentiment_empty_unavailable(monkeypatch):
    monkeypatch.setattr(
        "tradingagents.dataflows.providers.finnhub_sentiment.make_api_request", lambda *a, **k: {}
    )

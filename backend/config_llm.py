        ...
        *,
        ...
        return {
            ...
            "news": {
                ...
                "rss_feed_failure_cooldown_seconds": NEWS_RSS_FEED_FAILURE_COOLDOWN_SECONDS,
            ...
            "general_news": {
                ...
                "marketaux_api_key": MARKETAUX_API_KEY,
                "newsdata_api_key": NEWSDATA_API_KEY,
                "enabled": GENERAL_NEWS_ENABLED,
                "provider_priority": GENERAL_NEWS_PROVIDER_PRIORITY,
                "enabled_providers": GENERAL_NEWS_ENABLED_PROVIDERS,
                "enable_background_refresh": GENERAL_NEWS_ENABLE_BACKGROUND_REFRESH,
                "refresh_interval_seconds": GENERAL_NEWS_REFRESH_INTERVAL_SECONDS,
                "cache_ttl_seconds": GENERAL_NEWS_CACHE_TTL_SECONDS,
                "stale_ttl_seconds": GENERAL_NEWS_STALE_TTL_SECONDS,
                "background_refresh_seconds": NEWS_BACKGROUND_REFRESH_SECONDS,
                "rss_max_concurrency": NEWS_RSS_MAX_CONCURRENCY,
                "provider_max_concurrency": NEWS_PROVIDER_MAX_CONCURRENCY,
                "manual_refresh_cooldown_seconds": NEWS_MANUAL_REFRESH_COOLDOWN_SECONDS,
                "provider_429_cooldown_seconds": NEWS_PROVIDER_429_COOLDOWN_SECONDS,
                "rss_rotation_batch_size": NEWS_RSS_ROTATION_BATCH_SIZE,
                "max_stored_articles": NEWS_MAX_STORED_ARTICLES,
                "article_retention_days": NEWS_ARTICLE_RETENTION_DAYS,
                "ui_default_limit": NEWS_UI_DEFAULT_LIMIT,
                "force_refresh_allowed": NEWS_FORCE_REFRESH_ALLOWED,
                "frontend_poll_seconds": GENERAL_NEWS_FRONTEND_POLL_SECONDS,
                "enable_sse": GENERAL_NEWS_ENABLE_SSE,
                "default_window_days": GENERAL_NEWS_DEFAULT_WINDOW_DAYS,
                "max_articles_per_provider": GENERAL_NEWS_MAX_ARTICLES_PER_PROVIDER,
                "max_articles_for_ui": GENERAL_NEWS_MAX_ARTICLES_FOR_UI,
                "default_limit": GENERAL_NEWS_DEFAULT_LIMIT,
                "default_category": GENERAL_NEWS_DEFAULT_CATEGORY,
                "allowed_categories": GENERAL_NEWS_ALLOWED_CATEGORIES,
                "rss_primary": GENERAL_NEWS_RSS_PRIMARY,
                "rss_max_feeds": GENERAL_NEWS_RSS_MAX_FEEDS,
                "rss_max_items_per_feed": GENERAL_NEWS_RSS_MAX_ITEMS_PER_FEED,
                "rss_enabled": NEWS_RSS_ENABLED,
                "rss_include_trial_feeds": NEWS_RSS_INCLUDE_TRIAL_FEEDS,
                "rss_google_news_fallback_enabled": NEWS_RSS_GOOGLE_NEWS_FALLBACK_ENABLED,
                "rss_enabled_feed_ids": NEWS_RSS_ENABLED_FEED_IDS,
                ...
                "rss_feed_failure_cooldown_seconds": NEWS_RSS_FEED_FAILURE_COOLDOWN_SECONDS,
                "log_provider_requests": NEWS_LOG_PROVIDER_REQUESTS,
                "vendor_timeout_seconds": GENERAL_NEWS_VENDOR_TIMEOUT_SECONDS,
                "vendor_max_retries": GENERAL_NEWS_VENDOR_MAX_RETRIES,
                "cache_enabled": GENERAL_NEWS_CACHE_ENABLED,
                "cache_db_path": GENERAL_NEWS_CACHE_DB_PATH,
                "cache_max_entries": GENERAL_NEWS_CACHE_MAX_ENTRIES,
            },

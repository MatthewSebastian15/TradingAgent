...
DEFAULT_CONFIG = {
    ...
    "data_vendor_max_calls_per_analysis": int(_env("DATA_VENDOR_MAX_CALLS_PER_ANALYSIS") or "12"),
    ...
    "data_vendor_enable_finnhub_enrichment": (_env("DATA_VENDOR_ENABLE_FINNHUB_ENRICHMENT") or "true").lower() == "true",

...
DEFAULT_CONFIG = {
    ...
    "news": {
        ...
        "provider_priority": _env("NEWS_PROVIDER_PRIORITY") or "google_news_light,marketaux,newsdata",
        "enabled_providers": _env("NEWS_ENABLED_PROVIDERS") or "google_news_light,marketaux,newsdata",

...
DEFAULT_CONFIG = {
    ...
    "news": {
        ...
        "rss_max_feeds": int(_env("NEWS_RSS_MAX_FEEDS") or "50"),
        "rss_max_items_per_feed": int(_env("NEWS_RSS_MAX_ITEMS_PER_FEED") or "20"),
        "rss_include_trial_feeds": _env_bool("NEWS_RSS_INCLUDE_TRIAL_FEEDS", True),
        ...
        "rss_disabled_feed_ids": _env("NEWS_RSS_DISABLED_FEED_IDS") or "",
    ...
    "general_news": {
        ...
        or "all,markets,world,finance,tech,macro,central_bank,regulatory,forex,crypto",
        "rss_primary": _env_bool("GENERAL_NEWS_RSS_PRIMARY", True),
        "rss_max_feeds": int(_env("GENERAL_NEWS_RSS_MAX_FEEDS") or "50"),

...
DEFAULT_CONFIG = {
    ...
    "news": {
        ...
        "rss_enabled": _env_bool("NEWS_RSS_ENABLED", True),
        "rss_max_feeds": int(_env("NEWS_RSS_MAX_FEEDS") or "10"),
        "rss_max_items_per_feed": int(_env("NEWS_RSS_MAX_ITEMS_PER_FEED") or "20"),
        "rss_include_trial_feeds": _env_bool("NEWS_RSS_INCLUDE_TRIAL_FEEDS", False),
        "rss_google_news_fallback_enabled": _env_bool("NEWS_RSS_GOOGLE_NEWS_FALLBACK_ENABLED", True),
        "rss_enabled_feed_ids": _env("NEWS_RSS_ENABLED_FEED_IDS") or "",
        "rss_disabled_feed_ids": _env("NEWS_RSS_DISABLED_FEED_IDS") or "theblock-trial",
        "rss_user_agent": _env("NEWS_RSS_USER_AGENT") or "TradingAgent/0.1 RSS Reader",
    ...
    "general_news": {
        ...
        "allowed_categories": _env("GENERAL_NEWS_ALLOWED_CATEGORIES")
        or "all,market,macro,crypto,forex,commodities,regulatory,indonesia",
        "rss_primary": _env_bool("GENERAL_NEWS_RSS_PRIMARY", True),
        "rss_max_feeds": int(_env("GENERAL_NEWS_RSS_MAX_FEEDS") or "20"),
        "rss_max_items_per_feed": int(_env("GENERAL_NEWS_RSS_MAX_ITEMS_PER_FEED") or "30"),
        ...
        "cache_db_path": _env("GENERAL_NEWS_CACHE_DB_PATH") or ".cache/general_news.sqlite3",

...
def score_news_article(article: NormalizedNewsArticle, ticker_profile: dict[str, Any]) -> NormalizedNewsArticle:
    ...
    entity_match_scores = [entity.match_score for entity in matching_entities if entity.match_score is not None]

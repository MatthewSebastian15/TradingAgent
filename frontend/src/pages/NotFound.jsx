    ...
    <div className="min-h-screen bg-bloomberg-bg">
      ...
      <div className="flex flex-col items-center justify-center" style={{ minHeight: 'calc(100vh - 68px)' }}>
        <div className="text-center">
          <div className="font-display text-8xl font-bold text-bloomberg-border tracking-widest mb-4">404</div>
          <div className="font-mono text-sm text-bloomberg-muted tracking-wider mb-6">PAGE NOT FOUND</div>
          <button

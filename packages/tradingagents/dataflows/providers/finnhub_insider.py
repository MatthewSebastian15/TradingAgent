...
def get_insider_transactions(
    ...
    try:
        ...
        payload = make_api_request(
            "/stock/insider-transactions", params, feature_key="enable_insider"
        )
        ...
        return _dump(
            {
                ...
                "metadata": build_metadata(
                    "/stock/insider-transactions", is_enrichment=True, confidence="medium"
                ),
            }
        )
    except Exception as exc:
        return handle_finnhub_error(
            f"insider transactions for {ticker}", exc, fallback_next="alpha_vantage"
        )
        ...
        return _dump(
            {
                ...
                "metadata": build_metadata(
                    "/stock/insider-sentiment", is_enrichment=True, confidence="medium"
                ),
            }
        )
    except Exception as exc:

...
DEFAULT_CONFIG = {
    ...
    "news": {
        "google_news_light_api_key": _env("GOOGLE_NEWS_LIGHT_API_KEY"),
        ...
        "rss_include_trial_feeds": True,
        "rss_google_news_fallback_enabled": True,
        "rss_enabled_feed_ids": "",
        "rss_disabled_feed_ids": "",
        "rss_user_agent": "TradingAgent/0.1 RSS Reader",
        "cache_enabled": _env_bool("NEWS_CACHE_ENABLED", True),
        "cache_ttl_minutes": int(_env("NEWS_CACHE_TTL_MINUTES") or "60"),
        "cache_db_path": ".cache/news_data.sqlite3",
        ...
        "vendor_timeout_seconds": int(_env("NEWS_VENDOR_TIMEOUT_SECONDS") or "10"),
        "vendor_max_retries": int(_env("NEWS_VENDOR_MAX_RETRIES") or "1"),
    ...
    "general_news": {
        ...
        "frontend_poll_seconds": int(_env("GENERAL_NEWS_FRONTEND_POLL_SECONDS") or "60"),
        "enable_sse": _env_bool("GENERAL_NEWS_ENABLE_SSE", True),
        "default_window_days": int(_env("GENERAL_NEWS_DEFAULT_WINDOW_DAYS") or "7"),
        "max_articles_per_provider": int(_env("GENERAL_NEWS_MAX_ARTICLES_PER_PROVIDER") or "30"),
        ...
        "vendor_timeout_seconds": int(_env("GENERAL_NEWS_VENDOR_TIMEOUT_SECONDS") or "10"),
        "vendor_max_retries": int(_env("GENERAL_NEWS_VENDOR_MAX_RETRIES") or "1"),
        "cache_enabled": _env_bool("GENERAL_NEWS_CACHE_ENABLED", True),
        "cache_db_path": ".cache/general_news.sqlite3",
        "cache_max_entries": int(_env("GENERAL_NEWS_CACHE_MAX_ENTRIES") or "1000"),
    },
    "data_vendors": {
